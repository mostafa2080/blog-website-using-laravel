            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img src="{{ 'frontend/assets/img/images/services_details01.jpg' }}" alt="">
                    </div>
                    <div class="services__details__content">
                        ...
                        <div class="services__details__img">
                            <div class="row">
                                <div class="col-sm-6">
                                    <img src="{{ 'frontend/assets/img/images/services_details02.jpg' }}" alt="">
                                </div>
                                <div class="col-sm-6">
                                    <img src="{{ 'frontend/assets/img/images/services_details03.jpg' }}" alt="">
                                </div>
                            </div>
                        </div>
